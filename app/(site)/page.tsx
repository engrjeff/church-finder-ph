...
import MiniChurchList from './_components/MiniChurchList';
    ...
    <>
        ...
        <div className="grid gap-6 py-10 md:grid-cols-2">
          <div className="flex flex-col items-start gap-4 rounded-lg border bg-[rgba(255,255,255,0.1)] p-5">
            <span className="inline-flex items-center justify-center rounded-full bg-primary p-4">
              <ComponentBooleanIcon className="size-6" />
            </span>
      ...
      <section className="container max-w-screen-lg px-4 py-12 lg:py-20">
        ...
        <p className="mb-8 text-center text-xl text-muted-foreground">
          Other believers listed their churches here. You can be one of them
          soon!
        </p>
