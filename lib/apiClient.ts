import { Church, ChurchContact, ChurchProfile } from '@prisma/client';
...
export const churchApi = {
  ...
  churchContact: new APIClient<ChurchContact>('/church/contact-info'),
  pastorProfile: new APIClient<ChurchContact>('/church/pastor-profile'),
  churchMedia: new APIClient<ChurchContact>('/church/media'),
};
